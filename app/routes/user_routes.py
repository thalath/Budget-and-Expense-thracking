...
@user_bp.route("/<int:user_id>/delete", methods=["GET"]) #methods get: just called data from database and asked for delete
@login_required
...
@user_bp.route("/<int:user_id>/delete", methods=["POST"]) # methods post: confirm deleted data from database 
@login_required
